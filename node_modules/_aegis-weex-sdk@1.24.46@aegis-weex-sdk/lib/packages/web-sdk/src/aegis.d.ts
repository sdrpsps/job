import Core, { Config, SendOption, SendSuccess, SendFail, PayloadXHR, PayloadFetch } from "../../core/src";
export interface WebConfig extends Config {
    asyncPlugin?: boolean;
    reportApiSpeed?: boolean | {
        urlHandler: (url: string, payload: PayloadXHR | PayloadFetch) => string;
    };
...
export default class Aegis extends Core {
    ...
    requesting: boolean;
    private resetRequesting;
    request(options: SendOption, success?: SendSuccess, fail?: SendFail): boolean | void;
