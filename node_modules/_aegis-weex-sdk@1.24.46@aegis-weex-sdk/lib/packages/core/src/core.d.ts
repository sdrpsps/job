...
import { Config, LogType, Environment, SendOption, SendSuccess, SendFail, SpeedLog, ReportTimeLog, SendType, EventLog } from './interface';
...
export default class Core {
    ...
    speedLogPipeline(_log?: SpeedLog): void;
