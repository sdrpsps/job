export declare type WxApi = keyof typeof wx;
export declare type CloudApi = 'callFunction';
export declare type HackApi = WxApi | CloudApi;
...
export declare type HackApiCallbackOption = ReqOption & HackApiCallback;
