...
/* 0 */
/*!*****************************************************************!*\
  !*** /Users/hchow/Documents/HBuilderProjects/zhiyebang/main.js ***!
  \*****************************************************************/
...
var _mixins = _interopRequireDefault(__webpack_require__(/*! ./polyfill/mixins */ 144));




var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 145));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // @ts-ignore
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;_vue.default.use(_uviewUi.default); // 全局mixins，用于实现setData等功能';
_vue.default.mixin(_mixins.default);var vuexStore = __webpack_require__(/*! @/store/$u.mixin.js */ 147);_vue.default.mixin(vuexStore);_vue.default.config.productionTip = false;
...
/* 6 */
/*!*****************************************************************!*\
  !*** /Users/hchow/Documents/HBuilderProjects/zhiyebang/App.vue ***!
  \*****************************************************************/
/*! no static exports found */
...
/* 7 */
/*!******************************************************************************************!*\
  !*** /Users/hchow/Documents/HBuilderProjects/zhiyebang/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 8 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/hchow/Documents/HBuilderProjects/zhiyebang/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _timWxSdk = _interopRequireDefault(__webpack_require__(/*! tim-wx-sdk */ 9));
var _cosWxSdkV = _interopRequireDefault(__webpack_require__(/*! cos-wx-sdk-v5 */ 10));
...
var _aegisMpSdk = _interopRequireDefault(__webpack_require__(/*! aegis-mp-sdk */ 11));
...
var _logger = _interopRequireDefault(__webpack_require__(/*! ./utils/logger */ 12));
var _GenerateTestUserSig = __webpack_require__(/*! ./debug/GenerateTestUserSig.js */ 15);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
// APP 和 小程序平台
// app.js
var aegis = new _aegisMpSdk.default({ id: 'iHWefAYqKznuxWjLnr', // 项目key
  reportApiSpeed: true // 接口测速
});uni.$aegis = aegis; // 首先需要通过 uni.requireNativePlugin("ModuleName") 获取 module
var _default =
...

{
  onLaunch: function onLaunch() {
    var SDKAppID = (0, _GenerateTestUserSig.genTestUserSig)('').sdkAppID;
    ...
    uni.$TUIKitTIM = _timWxSdk.default;
    uni.$TUIKitEvent = _timWxSdk.default.EVENT;
    uni.$TUIKitVersion = _timWxSdk.default.VERSION;
    uni.$TUIKitTypes = _timWxSdk.default.TYPES; // 监听系统级事件
  ...
  globalData: {
    ...
    headerHeight: 0,
    statusBarHeight: 0,
    SDKAppID: (0, _GenerateTestUserSig.genTestUserSig)('').sdkAppID },
  ...
  methods: {
    ...
    resetLoginData: function resetLoginData() {
      ...
      _logger.default.log("| app |  resetLoginData | globalData: ".concat(this.globalData));
    },
    onTIMError: function onTIMError() {},
    onSDKReady: function onSDKReady(_ref)

    {var name = _ref.name;
      var isSDKReady = name === uni.$TUIKitEvent.SDK_READY ? true : false;
      // 修改vuex里面的isImReady
    ...
    onNetStateChange: function onNetStateChange() {},
    onSDKReload: function onSDKReload() {},
    onSdkNotReady: function onSdkNotReady() {},
    onKickedOut: function onKickedOut() {
      uni.showToast({
        title: '您被踢下线',
        icon: 'error' });
...
/* 17 */
/*!***************************************************************************************************!*\
  !*** /Users/hchow/Documents/HBuilderProjects/zhiyebang/App.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/hchow/Documents/HBuilderProjects/zhiyebang/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
